...
class AudioProvider:
    ...
    def search(self, song: Song, only_verified: bool = False) -> Optional[Tuple[Result, float]]:
        """
        Search for a song and return best match together with score.
